...
import 'package:flutter_bloc_note_app/config/constants.dart';
...
class ThemesBloc extends Bloc<ThemesEvent, ThemeState> {
  @override
  ThemeState get initialState =>
      ThemeState(themeData: Themes.themeData[AppTheme.LightTheme]);

  @override
  Stream<ThemeState> mapEventToState(ThemesEvent event) async* {
