...
part 'notes_detail_event.dart';
part 'notes_detail_state.dart';

class NotesDetailBloc extends Bloc<NotesDetailEvent, NoteDetailState> {
  ...
  @override
  Stream<NoteDetailState> mapEventToState(NotesDetailEvent event) async* {
